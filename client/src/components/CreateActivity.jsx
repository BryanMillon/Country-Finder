...
export default function AddActivity(){
    ...
    function validate(input) {
      let errors = {};
      if (!input.name){errors.name = "Please, enter a Activity name.";}
      if(!input.difficulty){errors.difficulty = "Please, select the difficulty";}
      if(!input.duration){errors.duration = "Please, select the duration";}
      if(!input.season){errors.season = "Please, select the season";}
...
<div className={styles.divMiniCards} key={country}>
        ...
        <input className={styles.btnMiniCards} type="button" onClick={() => handleDelete(country)}  value="X" />       
  ...
  <input className={styles.btn} 
         ...
         disabled={!input.name ||!input.difficulty ||!input.duration ||!input.season ||!input.countries.length }
          />
</div>
</form>
    </div>
